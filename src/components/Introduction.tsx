export function Introduction() {
    return (
        <div className='flex items-center text-center p-20 rounded-sm  h-full grow justify-center gap-8 '>
            <div
                className='flex text-2xl flex-col  items-center p-12 text-gray-50 rounded-2xl border-2 border-blue-300/60 bg-blue-300/10 shadow-2xl duration-200 ease-out hover:scale-105'>

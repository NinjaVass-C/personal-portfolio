    ...
    <body className='bg-fixed' style={{backgroundImage: 'linear-gradient(7deg,rgba(13, 4, 110, 1) 0%, rgba(71, 178, 174, 1) 77%, rgba(100, 214, 237, 1) 100%'}}>
      ...
      <div id='about' className={'flex flex-col h-screen py-5'} >
        ...
        <div className='grid grid-cols-2 gap-6 p-5 grow items-center'>
          <AboutCard inputText={'Outside of programming, you can typically find me listening to all sorts of metal music, playing various video games, and watching Esports like CS2 and Valorant. Fun fact: I play Clone Hero, a modern clone of the Guitar Hero games, and collect the instruments from various games!'} inputTitle={'Hobbies'}/>
          <AboutCard inputText={'I started learning about software development during high school, learning basic html and css in Graphic Design. As I continued, I started using Java in Greenfoot and Netbeans, learning basic fundamentals like OOP and recursion. This turned to a passion for software development, and the direction for my future!'} inputTitle={'How I Started'}/>
          <AboutCard inputText={'As I mentioned, I am a big fan of metal music. I enjoy metal songs from all generations, but my favourites are metalcore and deathcore influenced by the 2000s to 2010s. Some of my favourite bands right now are Like Moths to Flames, 156/Silence, and Protest the Hero. '} inputTitle={'Music'}/>
      ...
      <div id='experience' className={'flex flex-col h-screen py-5'} >
        <h2 className='text-6xl font-bold my-8 justify-center flex text-gray-50'>My Experience</h2>
          <div className='grid grid-cols-1 gap-6 p-5 grow items-center'>
            <ExperienceCard inputTitle={{company: 'Elentra', role: 'Student Software Developer', techStack: '(PHP/Laravel, Javascript, MySQL)', url: 'https://elentra.com/'}} inputText={[
              ...
              <ExperienceCard inputTitle={{company: 'HackSLC Project: Dropadox', role: 'Developer', techStack: '(Nuxt.js, SQLite, Tailwind, Drizzle ORM, ShadCN)', url: 'https://github.com/Dropadox/dropadox'}} inputText={[
